  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.17);borderRadius:10px">
        <h1 class="h1" style="color:rgba(36, 194, 205, 1);fontSize:28px;">职称评审管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.lianxidianhua" autocomplete="off" placeholder="联系电话" type="text" />
																								...
																								<!-- <div v-if="tableName=='pingshenyuan'" class="input-group">
			   <div class="label">工号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.gonghao" class="input" type="text" placeholder="工号">
			   </div>
			 </div> -->
			<el-form-item label="工号" class="input" v-if="tableName=='pingshenyuan'">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='pingshenyuan'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='pingshenyuan'" class="input-group">
			   <div class="label">评审员姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.pingshenyuanxingming" class="input" type="text" placeholder="评审员姓名">
			   </div>
			 </div> -->
			<el-form-item label="评审员姓名" class="input" v-if="tableName=='pingshenyuan'">
			  <el-input v-model="ruleForm.pingshenyuanxingming" autocomplete="off" placeholder="评审员姓名" type="text" />
			</el-form-item>
																														<!-- <div v-if="tableName=='pingshenyuan'" class="input-group">
			...
			<el-form-item label="手机" class="input" v-if="tableName=='pingshenyuan'">
			...
			<el-form-item label="身份证" class="input" v-if="tableName=='pingshenyuan'">
  ...
  methods: {
    ...
    login() {
        ...
        return
                                                                  ...
                                                                  if((!this.ruleForm.gonghao) && `pingshenyuan` == this.tableName){
        this.$message.error(`工号不能为空`);
        return
      }
                                                                  if((!this.ruleForm.mima) && `pingshenyuan` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
                                                                                                                                                                                                                                                            if(`pingshenyuan` == this.tableName && this.ruleForm.shouji&&(!this.$validate.isMobile(this.ruleForm.shouji))){
        this.$message.error(`手机应输入手机格式`);
        return
      }
                                                                              if(`pingshenyuan` == this.tableName && this.ruleForm.shenfenzheng&&(!this.$validate.checkIdCard(this.ruleForm.shenfenzheng))){
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210110/be764c0d6a7a4c85a0c62f8bdd74459c.jpg");
		height: 100vh;
