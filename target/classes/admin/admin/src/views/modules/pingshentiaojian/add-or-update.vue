        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.shengfen"
                placeholder="省份" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="评审专业" prop="pingshenzhuanye">
          <el-select v-model="ruleForm.pingshenzhuanye" placeholder="请选择评审专业">
            <el-option
                v-for="(item,index) in pingshenzhuanyeOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.fengmiantu" label="封面图" prop="fengmiantu">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.fengmiantu.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="评审时间" prop="pingshenshijian">
          <el-input v-model="ruleForm.pingshenshijian" 
              placeholder="评审时间" clearable  :readonly="ro.pingshenshijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="评审时间" prop="pingshenshijian">
              <el-input v-model="ruleForm.pingshenshijian" 
                placeholder="评审时间" readonly></el-input>
                                                                  ...
                                                                  <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="资料清单" prop="ziliaoqingdan">
          <file-upload
          tip="点击上传资料清单"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.ziliaoqingdan?ruleForm.ziliaoqingdan:''"
          @change="ziliaoqingdanUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.ziliaoqingdan" label="资料清单" prop="ziliaoqingdan">
            <el-button type="text" size="small" @click="download(ruleForm.ziliaoqingdan)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
                                                                  <el-col :span="12">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.zhuyishixiang" label="注意事项" prop="zhuyishixiang">
                    <span>{{ruleForm.zhuyishixiang}}</span>
                                                                                                                                                      ...
                                                                                                                                                      <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="评审条件" prop="pingshentiaojian">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.pingshentiaojian" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.pingshentiaojian" label="评审条件" prop="pingshentiaojian">
                    <span v-html="ruleForm.pingshentiaojian"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	clicknum : false,
            ...
            ruleForm: {
                        ...
                        shengfenOptions: [],
                                pingshenzhuanyeOptions: [],
                                                                                                                                                  rules: {
                  shengfen: [
                            { required: true, message: '省份不能为空', trigger: 'blur' },
                                    	                                                              ],
                  pingshenzhuanye: [
                            { required: true, message: '评审专业不能为空', trigger: 'blur' },
                                    	                                                              ],
                  zhichengjibie: [
                            { required: true, message: '职称级别不能为空', trigger: 'blur' },
                                    	                                                              ],
                  fengmiantu: [
                                    	                                                              ],
                  pingshenshijian: [
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.pingshenshijian = true;
            continue;
	            	            ...
	            	            if(o=='pingshentiaojian'){
            this.ruleForm.pingshentiaojian = obj[o];
	    this.ro.pingshentiaojian = true;
            continue;
          }
	            	            if(o=='ziliaoqingdan'){
            this.ruleForm.ziliaoqingdan = obj[o];
	    this.ro.ziliaoqingdan = true;
            continue;
          }
	            	            if(o=='zhuyishixiang'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `pingshentiaojian/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.pingshentiaojianCrossAddOrUpdateFlag = false;
                  this.parent.search();
    ...
    back() {
      ...
      this.parent.contentStyleChange();
				...
				this.addEditUploadStyleChange()
                                                        ...
                                                        ziliaoqingdanUploadChange(fileUrls) {
                this.ruleForm.ziliaoqingdan = fileUrls;
				this.addEditUploadStyleChange()
            },
                                                            	addEditStyleChange() {
	  this.$nextTick(()=>{
