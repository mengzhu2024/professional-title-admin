  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="职称级别" prop="zhichengjibie">
              <el-input v-model="ruleForm.zhichengjibie" 
                placeholder="职称级别" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="评审结果" prop="pingshenjieguo">
          <el-select v-model="ruleForm.pingshenjieguo" placeholder="请选择评审结果">
            <el-option
                v-for="(item,index) in pingshenjieguoOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="评审结果" prop="pingshenjieguo">
	      <el-input v-model="ruleForm.pingshenjieguo"
                placeholder="评审结果" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="工号" prop="gonghao">
              <el-input v-model="ruleForm.gonghao" 
                placeholder="工号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="评审员姓名" prop="pingshenyuanxingming">
          <el-input v-model="ruleForm.pingshenyuanxingming" 
              placeholder="评审员姓名" clearable  :readonly="ro.pingshenyuanxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="评审员姓名" prop="pingshenyuanxingming">
              <el-input v-model="ruleForm.pingshenyuanxingming" 
                placeholder="评审员姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
...
export default {
	...
	pingshenyuanxingming : false,
            ...
            ruleForm: {
                	        yonghuming: '',
	                        	        ...
	                        	        pingshenriqi: '',
	                        	        gonghao: '',
	                        	        pingshenyuanxingming: '',
	                      },
                                                                                              pingshenjieguoOptions: [],
                                                              rules: {
                  yonghuming: [
                                    	                                                              ],
                  yonghuxingming: [
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.gonghao = true;
            continue;
	            	            ...
	            	            if(o=='pingshenyuanxingming'){
            this.ruleForm.pingshenyuanxingming = obj[o];
	    this.ro.pingshenyuanxingming = true;
            continue;
          }
	                    }
                                                                                                                                                              }
        ...
        if (data && data.code === 0) {
          var json = data.data;
              		...
              		this.ruleForm.gonghao = json.gonghao
                                  		...
                                  		if(json.pingshenyuanxingming!=''&&json.pingshenyuanxingming){
              		this.ruleForm.pingshenyuanxingming = json.pingshenyuanxingming
		}
                              } else {
          this.$message.error(data.msg);
        }
      });
                                                                                                                                    this.pingshenjieguoOptions = "通过,不通过".split(',')
                                                                                  },
                                                                                // 多级联动参数
                                                                                                      info(id) {
      this.$http({
        url: `jieguogongbu/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `jieguogongbu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jieguogongbuCrossAddOrUpdateFlag = false;
                  this.parent.search();
